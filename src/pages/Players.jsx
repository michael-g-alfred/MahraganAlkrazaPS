          ...
          <table
            ...
            <thead className="bg-blue-700 text-white text-sm">
              <tr>
                ...
                <th scope="col" className="p-2 sm:p-3 text-center bg-green-700">
                  اسم الفريق
                </th>
                {canAction && (
                  <th scope="col" className="p-2 sm:p-3 text-center bg-red-700">
                    إجراءات
                  </th>
                )}
              </tr>
            ...
            <tbody className="text-blue-700 bg-white text-sm">
              {filteredPlayers.map((player, index) => (
                <tr
                  ...
                  <td className="p-2 sm:p-3 text-center font-semibold bg-blue-100">
                    {index + 1}
                  </td>
                  ...
                  <td
                    className="p-2 sm:p-3 text-center font-mono bg-blue-100"
                    dir="ltr">
                    {player.nationalId || "—"}
                  </td>
                  ...
                  <td className="p-2 sm:p-3 text-center font-mono bg-blue-100">
                    {player.phone}
                  </td>
                  <td className="p-2 sm:p-3 text-center bg-blue-50">
                    {player.form}
